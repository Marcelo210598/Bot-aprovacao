...
// =============================================================================
//  BotAprovacao_SaidaParcial_REPLAY — copia renomeada de BotAprovacao_SaidaParcial.cs
//  (mesma logica, nenhuma mudanca funcional), criada 20/08/2026 pra rodar lado a
//  lado com BotAprovacao_BASELINE_REPLAY.cs no mesmo Market Replay (A/B
//  controlado, mesmos dados/timeframe/horario). O arquivo original
//  (BotAprovacao_SaidaParcial.cs) continua existindo e intocado — essa e' uma
//  copia adicional, nao um substituto. Unica diferenca de comportamento:
//  arquivo de PnL diario isolado (ver nota em CaminhoArquivoPnl() mais abaixo),
//  pra nao colidir com o arquivo que a BASELINE_REPLAY usa quando rodam juntas.
// =============================================================================
...
{
	public class BotAprovacao_SaidaParcial_REPLAY : Strategy
	{
		...
		protected override void OnStateChange()
		{
			...
			{
				Description					= @"SaidaParcial_REPLAY — copia renomeada da versao experimental (E(4+1)@20pt + BE-lock 0,75), p/ rodar lado a lado com BASELINE_REPLAY no mesmo Market Replay. Logica identica ao BotAprovacao_SaidaParcial original.";
				Name						= "BotAprovacao_SaidaParcial_REPLAY";
		...
		private string CaminhoArquivoPnl()
		{
			...
			return Path.Combine(
				...
				"NinjaTrader 8", "BotAprovacao_SaidaParcial_REPLAY_pnl_diario.txt");
		}
