...
um contrato JA EXPIRADO ('MNQ 12-23') de proposito: o NT8 nao busca dados de
...
Depois de importar em 'MNQ 12-23', rodar OnFadeHarness no Strategy Analyzer
apontando 'Ativo = MNQ 12-23', periodo 2024-09-13 -> 2024-11-01.
"""
...
NOME_NO_ZIP = "MNQ 12-23.txt"   # contrato EXPIRADO -> NT8 nao mistura feed
...
def main():
    ...
    for _, s in linhas:
        if s.startswith("20240913 08"):   # ~08:xx Chicago = ~09:xx ET
